...
Projeto desenvolvido como Desafio de Código no bootcamp da **DIO**.

##  Tecnologias e Recursos
* **Spring Boot 3** & **Spring AI**
* **ChatClient & Tool Calling** para interpretação de intenções financeiras
* **Transcrição de Áudio (Audio-to-Text)**
* **Spring Data JPA & H2 Database**

##  Evoluções Implementadas
1. **Validação de Regra de Negócio:** Adicionada verificação no serviço para impedir o cadastro de transações com valores negativos ou zerados.
2. **Método de Consulta de Saldo:** Implementada lógica para cálculo e consolidação do saldo total das transações cadastradas.