...
public class TransactionController {
    ...
    ResponseEntity<Resource> transcribe(@RequestParam("file") MultipartFile file) {
        // EVOLUÇÃO: Validação do arquivo antes de processar pela IA
    ...
    // EVOLUÇÃO: Endpoint REST para checar se o serviço de IA e Spring AI estão operacionais
    @GetMapping("/ai/status")
    public ResponseEntity<String> checkAiStatus() {
        return ResponseEntity.ok("Serviço de IA com Spring AI está ativo e operacional!");
    }
}